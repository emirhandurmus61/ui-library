      ...
      <header className="fixed top-3 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-1.5rem)] max-w-3xl">
        <nav className="flex items-center justify-between h-11 px-4 rounded-2xl border border-border/25 bg-background/50 backdrop-blur-2xl shadow-[0_4px_30px_rgba(0,0,0,.06)]">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <a href="https://github.com/emirhandurmus61/ui-library" target="_blank" rel="noopener noreferrer" className="text-[12px] text-foreground-muted hover:text-foreground px-2.5 py-1 rounded-lg hover:bg-surface/60 transition-colors font-medium flex items-center gap-1">
        ...
        <div className="relative z-20 text-center max-w-3xl mx-auto px-4">
          ...
          <div className="fi-4 flex flex-wrap justify-center gap-3 mb-8">
            ...
            <MagneticButton strength={10}>
              <a href="https://github.com/emirhandurmus61/ui-library" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 font-semibold px-7 py-3.5 rounded-xl text-sm border border-border/40 bg-surface/40 backdrop-blur-sm text-foreground hover:border-primary/30 transition-all">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          ...
          <div className="py-16 flex flex-col items-center text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              ...
              <a href="https://github.com/emirhandurmus61/ui-library" target="_blank" rel="noopener noreferrer" className="text-foreground-muted hover:text-foreground transition-colors font-medium">GitHub</a>
            </div>
          </div>
