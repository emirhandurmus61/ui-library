  ...
  return (
    <div className={cn(
      ...
      {showSocials && (
        <>
          <div className="flex flex-col gap-2">
            <Button type="button" variant="outline" className="w-full" leftIcon={<GoogleIcon />} onClick={onGoogleLogin}>
              Google ile devam et
            </Button>
            <Button type="button" variant="outline" className="w-full" leftIcon={<GithubIcon />} onClick={onGithubLogin}>
              GitHub ile devam et
            </Button>
          </div>
      ...
      <p className="text-center text-sm text-foreground-muted">
        Hesabınız yok mu?{" "}
        <a href={registerHref} className="text-primary font-medium hover:underline">
          Ücretsiz kayıt ol
        </a>
      </p>
    </div>
